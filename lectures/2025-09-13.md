...
- Теоретический материал закончится примерно в ноябре, т.е. в декабре лекции не планируются.
- В декабре будет рейтинговый зачёт, дополнительные сдачи заданий и собеседования по теории. Рейтинг формируется на основе сданных лабораторных работ, собеседование необходимо для проверки знаний.
- На лекциях и лабораторных работах будет рассказан весь необходимый материал для выполнения заданий и прохождения собеседования. То, что не было рассказано на лекциях, будет преподнесено на лабораторных работах.
- Позже в группе отправят литературу. Если нет, то нужно будет напомнить преподавателю.
- Алгоритмы курса можно смело реализовывать на любом языке программирования вне заданий, поэтому действительно классная дисциплина.
- Лабораторные работы можно сдавать любому принимающему. Если лаборант 1 сделал замечание(-я), то лаборанту 2 они неинтересны.
- До середины ноября (но постараются побыстрее) будет отправлен последний пакет задач.
- К концу октября появится разбалловка рейтинга.
